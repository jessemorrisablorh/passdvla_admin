...
import 'package:pass_dvla_admin/Pages/rs_details_page.dart';
...
class RsSubCategoriesPage extends StatefulWidget {
  final String name;
  final List subcategories;
  final String categoory;
  const RsSubCategoriesPage({
    super.key,
    required this.name,
  ...
  @override
  State<RsSubCategoriesPage> createState() => _RsSubCategoriesPageState();
}

class _RsSubCategoriesPageState extends State<RsSubCategoriesPage> {
  @override
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth > 1200) {
          return DesktopRsSubCategories(
            name: widget.name,
            subcategories: widget.subcategories,
            categoory: widget.categoory,
          );
...
class DesktopRsSubCategories extends StatefulWidget {
  final String name;
  final List subcategories;
  final String categoory;
  const DesktopRsSubCategories({
    super.key,
    required this.name,
    required this.subcategories,
    required this.categoory,
  ...
  @override
  State<DesktopRsSubCategories> createState() => _DesktopRsSubCategoriesState();
}

class _DesktopRsSubCategoriesState extends State<DesktopRsSubCategories> {
  int currentPage = 0;
...
class MobileRsSubCategories extends StatefulWidget {
  final String name;
  final List subcategories;
  final String categoory;
  const MobileRsSubCategories({
    super.key,
    required this.name,
    required this.subcategories,
    required this.categoory,
  ...
  @override
  State<MobileRsSubCategories> createState() => _MobileRsSubCategoriesState();
}

class _MobileRsSubCategoriesState extends State<MobileRsSubCategories> {
  @override
  Widget build(BuildContext context) {
